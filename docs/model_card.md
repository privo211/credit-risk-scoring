...
- **Version**: 2.0.0
- **Model Type**: Ensemble (Random Forest with SMOTE + Platt Calibration)
- **Date**: June 2026
...
2. SMOTE oversampling to balance training classes (600 -> 840 samples)
...
|---|---|---|
| Actual 0 | TN=127 | FP=13 |
| Actual 1 | FN=32 | TP=28 |
...
- Recall of 0.4667 means the model misses approximately 53% of defaults
