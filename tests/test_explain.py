...
class TestExplainGlobal:
    def test_returns_dataframe(self, trained_model, trained_preprocessor, sample_data):
    ...
    def test_importance_sorted_descending(self, trained_model, trained_preprocessor, sample_data):
    ...
    def test_graceful_no_shap(self, monkeypatch, trained_model, trained_preprocessor, sample_data):
    ...
    def test_feature_names_from_dataframe(self, trained_model, trained_preprocessor, sample_data):
...
class TestExplainLocal:
    def test_returns_dict(self, trained_model, trained_preprocessor, sample_data):
    ...
    def test_single_sample_returns_dict_shap(self, trained_model, trained_preprocessor, sample_data):
    ...
    def test_batch_returns_list(self, trained_model, trained_preprocessor, sample_data):
